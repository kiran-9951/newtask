        ...
        <section class="task-detail-view">
            ...
            <article>
                ...
                <p><strong>Priority:</strong> 
                    <span class="priority" style="color: ${getPriorityColor(
                      task.priority
                    )};">
                        ${task.priority}
                    </span>
...
function displayTasks(tasks) {
  ...
  taskList.innerHTML = tasks
    .map(
      (task) => `
        <li class="task-item" data-id="${task.id}" onclick="showTaskDetails('${
        task.id
      }')" draggable="true">
...
function filterTasks() {
  ...
  const filteredTasks = priority
    ? api.filterTasksByPriority(priority)
    : api.getTasks();
  displayTasks(filteredTasks);
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    .addEventListener("click", () => loadContent("view-tasks"));
  document
    .getElementById("add-task")
    .addEventListener("click", () => loadContent("add-task"));
});
